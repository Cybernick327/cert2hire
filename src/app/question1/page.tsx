    ...
    >
        ...
        >
          ...
          >
            ...
            <button
              ...
              style={{ display: "flex", alignItems: "center", gap: "5px", backgroundColor: "#0066CC", color: "white", border: "none", borderRadius: "20px", padding: "5px 14px", fontSize: "12px", fontWeight: 600, cursor: "pointer" }}
            >
              Next →
            </button>
          </div>
          ...
          >
            <NetworkDiagram
              ...
              feedback={finishFeedback ? { ws1: scores.t3_openedWS1, router: scores.t4_openedRouterACL } : undefined}
            />
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div style={{ display: "flex", gap: "8px" }}>
          ...
          <button
            onClick={() => setFinishFeedback(true)}
            style={{
              backgroundColor: "#0A1628",
              color: "white",
              border: "none",
      ...
      {routerOpen && (
        <RouterModal
          ...
          t5Feedback={finishFeedback ? scores.t5_fixedRule2 : undefined}
        />
      )}
      ...
      {submitted && (
        <ResultsPanel
          ...
          onNext={() => { window.location.href = "/question2"; }}
        />
      )}
    </div>
  );
